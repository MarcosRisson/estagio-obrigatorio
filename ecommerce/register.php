                    ...
                    <div class="row">
                        ...
                        if (isset($_GET['success'])) {
                            if ($_GET['success'] == 'true') {
                                ...
                                echo '<script>showFailureAlert();</script>';
                            }
                        }
                        ?>
                        <form method="POST" action="processa_registro.php" onsubmit="return validateForm();">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="uf" name="uf" class="form-control" maxlength="2" style="width: 40px;" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label for="agree" class="form-check-label ml-2">Aceito os termos e condições</label>
                                    </div>
                                </div>
                                <div class="form-group">
